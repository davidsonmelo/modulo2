...
console.log("Essa é a melhor hora, quando podemos lhe servir, seja bem vindo!!!")
...
console.log("=========================================================")
console.log("Vamos realizar seu pedido. Informe o produto e a quantidade desejada!")
    ...
    if (prodt >= 1 && prodt <= 5) {
        ...
        for (let index2 = 0; qto != true; index2++) {
            ...
            if (quant <= 0 || isNaN(quant)) {
                ...
                relacaoPedido.push("Codigo e referencia: " + prodt + " - " + tabela[posicao].especificacao + " | Qtd: " + quant + " | " + " R$ " + (quant * tabela[posicao].preco).toFixed(2))
        ...
        if (nvpedido == "S" || nvpedido == "N" || nvpedido == "s" || nvpedido == "n" || !isNaN(nvpedido)) {
            if (nvpedido == "N" || nvpedido == "n") {
                console.log("Ok, obrigado por sua preferencia e aguarde o seu pedido!!!")
                op = true
            }
        }else{
        ...
        const npedido = input.question("Codigo do produto invalido, deseja realizar um pedido? (S) ou (N)")
